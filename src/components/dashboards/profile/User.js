    ...
    <UserContainer elevation={9}>
      <AvatarContainer>
        ...
        {isEditing.username ? (
            ...
            InputProps={{
              endAdornment: (
                <InputAdornment position="end">
                  {isEditing.username ? (
                    <IconButton onClick={() => handleEditDone("username")}>
                      <Check />
                    </IconButton>
                  ) : (
          ...
          >
            <Username variant="body1">{profileData.username}</Username>
            <IconButton onClick={() => handleEdit("username")}>
              <Edit
                style={{
                  visibility: isHovered.username ? "visible" : "hidden",
                }}
              />
            </IconButton>
          </Box>
      ...
      <TextFieldContainer>
        <Box sx={{ display: "flex", flexDirection: "row" }}>
          <StyledTextField
              ...
              endAdornment: (
                <InputAdornment position="end">
                  {isEditing.first_name ? (
                    <IconButton onClick={() => handleEditDone("first_name")}>
                      <Check />
                    </IconButton>
                  ) : (
                    <IconButton
                      ...
                      style={{
                        visibility: isHovered.first_name ? "visible" : "hidden",
                      }}
                    >
                      <Edit />
                    </IconButton>
            ...
            onChange={(e) => handleSave("first_name", e.target.value)}
          ...
          <StyledTextField
            ...
            InputProps={{
              endAdornment: (
                <InputAdornment position="end">
                  {isEditing.last_name ? (
                    <IconButton onClick={() => handleEditDone("last_name")}>
                      <Check />
                    </IconButton>
                  ) : (
                    <IconButton
                      ...
                      style={{
                        visibility: isHovered.last_name ? "visible" : "hidden",
                      }}
                    >
                      <Edit />
                    </IconButton>
            ...
            onChange={(e) => handleSave("last_name", e.target.value)}
        ...
        <StyledTextField
          ...
          InputProps={{
            endAdornment: (
              <InputAdornment position="end">
                {isEditing.serpapi ? (
                  <IconButton onClick={() => handleEditDone("serpapi")}>
                    <Check />
                  </IconButton>
                ) : (
                  <IconButton
                    ...
                    style={{
                      visibility: isHovered.serpapi ? "visible" : "hidden",
                    }}
                  >
                    <Edit />
                  </IconButton>
        ...
        <StyledTextField
          ...
          InputProps={{
            endAdornment: (
              <InputAdornment position="end">
                {isEditing.openai ? (
                  <IconButton onClick={() => handleEditDone("openai")}>
                    <Check />
                  </IconButton>
                ) : (
                  <IconButton
                    ...
                    style={{
                      visibility: isHovered.openai ? "visible" : "hidden",
                    }}
                  >
                    <Edit />
                  </IconButton>
