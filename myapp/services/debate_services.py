...
class DebateManager:
    def __init__(self, uid, conversation_id, role1, role2, app, num_rounds=4):
        ...
        self.agent1 = MasterAgent(self.message_service, self.uid, system_prompt=self.role1)
        self.agent2 = MasterAgent(self.message_service, self.uid, system_prompt=self.role2)
